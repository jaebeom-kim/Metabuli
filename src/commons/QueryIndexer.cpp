...
void QueryIndexer::indexQueryFile(size_t processedQueryNum) {
    ...
    if (seqMode == 1 || seqMode == 3) {
        ...
        while (kseq->ReadEntry()) {
            ...
            int kmerCnt_int = LocalUtil::getQueryKmerNumber<int>(kseq->entry.sequence.l, this->kmerLen);
            if (kmerCnt_int > 0) {
        ...
        while(true) {
            if (kseq_1->ReadEntry()) {
                ...
                kmerCnt_int_1 = LocalUtil::getQueryKmerNumber<int>(kseq_1->entry.sequence.l, this->kmerLen);
            } else {
                end = true;
            }
            ...
            if (kseq_2->ReadEntry()) {
                ...
                kmerCnt_int_2 = LocalUtil::getQueryKmerNumber<int>(kseq_2->entry.sequence.l, this->kmerLen);                
            } else {
                end = true;
            }
