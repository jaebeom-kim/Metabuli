...
std::vector<Command> metabuliCommands = {
        ...
        {"create-candidates", createCandidates, &localPar.createCandidates, COMMAND_MAIN,
                "Generate a species-candidate DB (multi-mapping) without classifying",
                nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<i:query file(s)> <i:database directory> <o:candidate DB> ",
                CITATION_SPACEPHARER,
                {{"FASTA/Q", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA | DbType::VARIADIC, &DbValidator::flatfile},
                 {"DB dir", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::directory},
                 {"candidate DB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
        {"classify-candidates", classifyCandidates, &localPar.classifyCandidates, COMMAND_MAIN,
                ...
                {{"candidate DB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 ...
                 {"out dir", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory},
                 {"job ID", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
        {"filter-candidates", filterCandidates, &localPar.filterCandidates, COMMAND_MAIN,
                "Filter a species-candidate DB by average score and genome coverage",
                nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<i:candidate DB> <i:database directory> <o:filtered candidate DB> ",
                CITATION_SPACEPHARER,
                {{"candidate DB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 {"DB dir", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::directory},
                 {"filtered candidate DB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
        {"view-candidates", viewCandidates, &localPar.viewCandidates, COMMAND_FORMAT_CONVERSION,
                "Dump a species-candidate DB to a human-readable TSV (development helper)",
                nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<i:candidate DB> <i:DB directory> <o:output TSV> ",
                CITATION_SPACEPHARER,
                {{"candidate DB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 {"DB dir", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::directory},
                 {"output TSV", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
        ...
        {"refine-report", refine_report, &localPar.refineReport, COMMAND_FORMAT_CONVERSION,
                "Get a refined report from a read-by-read result file",
                nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<i: read-by-read result> <i: database directory> <o: output file name>",
                CITATION_SPACEPHARER,
                {{"read-by-read result", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                {"database directory", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::directory},
                {"output file name", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
