...
std::vector<Command> commands = {
       ...
       {"build", build, &localPar.build, COMMAND_DATABASE_CREATION,
        ...
        {"build-func", build_func, &localPar.build_functional, COMMAND_DATABASE_CREATION,
                "Build taxonomy- and functional-annotated referece metamer database.",
               nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<DB dir> <FASTA list> <Accesssion2taxid> <Kaiju DB dir>",
                CITATION_SPACEPHARER,
                {{"Directory where the DB will be generated", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory},
                 {"A list of FASTA files", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 {"Mapping file (accession to tax ID)", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 {"Kaiju FMI directory", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::directory}}},
        {"build-kaiju", build_kaiju, &localPar.build_kaiju, COMMAND_DATABASE_CREATION,
                "Build Kaiju index and mapping files required to create Metabuli's functional DB.",
               nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<DB dir> <Protein FASTA>",
                CITATION_SPACEPHARER,
                {{"Directory to store output files", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory},
                 {"Protein FASTA file", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
        ...
        {"expand_diffidx_func", expand_diffidx_func, &localPar.build, COMMAND_EXPERT,
                "expand functional differential index",
               nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<diffIdx>",
                CITATION_SPACEPHARER,
