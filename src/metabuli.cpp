...
std::vector<Command> commands = {
       ...
       {"build", build, &localPar.build, COMMAND_DATABASE_CREATION,
        ...
        {"build-func", build_func, &localPar.build_functional, COMMAND_DATABASE_CREATION,
               ...
               nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<DB dir> <FASTA list> <Accesssion2taxid> <Kaiju FMI>",
                CITATION_SPACEPHARER,
                {{"Directory where the DB will be generated", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::empty},
                 {"A list of FASTA files", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 {"Mapping file (accession to tax ID)", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile},
                 {"Kaiju's FM index", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
        {"build_uniref", build_uniref, &localPar.build, COMMAND_EXPERT,
                "Build UniRef90 index",
               nullptr,
                "Jaebeom Kim <jbeom0731@gmail.com>",
                "<DB dir> <UniRef90 FASTA>",
                CITATION_SPACEPHARER,
                {{"Database directory", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::empty},
                 {"UniRef90 FASTA file", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile}}},
